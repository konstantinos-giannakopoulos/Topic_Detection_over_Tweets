...
public class Fixer {
	...
	this.stopwords.add("he"); this.stopwords.add("she");
	this.stopwords.add("we"); this.stopwords.add("they"); 
	this.stopwords.add("it");
	this.stopwords.add("i'm");this.stopwords.add("you're");
	this.stopwords.add("he's");this.stopwords.add("she's");
	this.stopwords.add("it's"); this.stopwords.add("its");
	this.stopwords.add("you're"); this.stopwords.add("they're");

	this.stopwords.add("my"); this.stopwords.add("me"); 
	this.stopwords.add("his"); this.stopwords.add("her"); 
	this.stopwords.add("your");
	this.stopwords.add("mine");this.stopwords.add("yours");

	this.stopwords.add("not"); this.stopwords.add("no");
	this.stopwords.add("aren't"); this.stopwords.add("arent");
	this.stopwords.add("can");this.stopwords.add("cannot");this.stopwords.add("can't");
	this.stopwords.add("is"); this.stopwords.add("am");
	this.stopwords.add("be"); this.stopwords.add("are"); this.stopwords.add("been");
	this.stopwords.add("do"); this.stopwords.add("don't"); this.stopwords.add("dont");
	this.stopwords.add("does"); this.stopwords.add("doesn't"); this.stopwords.add("doesnt");
	this.stopwords.add("was"); this.stopwords.add("were");
	this.stopwords.add("wasn't");this.stopwords.add("weren't");
	this.stopwords.add("get"); this.stopwords.add("got");
	this.stopwords.add("have"); this.stopwords.add("has");
	this.stopwords.add("haven't"); this.stopwords.add("hasn't");

	this.stopwords.add("need"); this.stopwords.add("should");
	this.stopwords.add("could"); this.stopwords.add("would");
	this.stopwords.add("will"); this.stopwords.add("shall");
	this.stopwords.add("still");

	this.stopwords.add("get"); this.stopwords.add("will"); 	
	this.stopwords.add("thank"); this.stopwords.add("want"); 

	this.stopwords.add("to"); this.stopwords.add("the");
	this.stopwords.add("a"); this.stopwords.add("an");      
	this.stopwords.add("and"); this.stopwords.add("or"); this.stopwords.add("but");
	
	this.stopwords.add("when"); this.stopwords.add("who");
	this.stopwords.add("how"); this.stopwords.add("where"); 
	this.stopwords.add("what"); this.stopwords.add("why");

	this.stopwords.add("this"); this.stopwords.add("that"); 
	this.stopwords.add("these");this.stopwords.add("those");

	this.stopwords.add("here"); this.stopwords.add("there");      

	this.stopwords.add("in"); this.stopwords.add("for");
	this.stopwords.add("of"); this.stopwords.add("on");
	this.stopwords.add("so"); this.stopwords.add("as"); 
	this.stopwords.add("at"); this.stopwords.add("up");
	this.stopwords.add("down"); this.stopwords.add("off");
	
	this.stopwords.add("all"); this.stopwords.add("just"); 
	this.stopwords.add("very"); this.stopwords.add("some"); this.stopwords.add("few");
	this.stopwords.add("with"); this.stopwords.add("without"); 
	this.stopwords.add("like");
	this.stopwords.add("much"); this.stopwords.add("more"); 
		
	this.stopwords.add("if"); this.stopwords.add("than");
	this.stopwords.add("even"); this.stopwords.add("unless");
	this.stopwords.add("about"); this.stopwords.add("by"); this.stopwords.add("only");

	this.stopwords.add("from"); 
	this.stopwords.add("too"); this.stopwords.add("more");
		
	this.stopwords.add("let's");

	this.stopwords.add("something"); this.stopwords.add("anything"); 
	this.stopwords.add("nothing");   	
	//time
	this.stopwords.add("now"); this.stopwords.add("then");   
	...
	this.stopwords.add("after"); this.stopwords.add("always"); this.stopwords.add("never");
